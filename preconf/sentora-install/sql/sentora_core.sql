...
(18,'news_url','Sentora News API URL','http://api.sentorang.org/latestnews.json',NULL,'Sentora News URL','Sentora Config','false'),
(19,'update_url','Sentora Update API URL','http://api.sentorang.org/latestversion.json',NULL,'Sentora Update URL','Sentora Config','false'),
